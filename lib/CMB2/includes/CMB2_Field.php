...
class CMB2_Field extends CMB2_Base
{
     ...
     * @since  1.1.0
     *
     * @param bool $raw Whether to retrieve pre-modidifed id.
     *
    ...
    public function get_data($field_id = '', $args = [])
    {
         ...
         *
         *     @var string $type     The current object type
         *     @var int    $id       The current object ID
         *     @var string $field_id The ID of the field being requested
         *     @var bool   $repeat   Whether current field is repeatable
         *     @var bool   $single   Whether current field is a single database row
         * }
         *
    ...
    public function update_data($new_value, $single = true)
    {
         ...
         *
         *     @var string $value    The value to set
         *     @var string $type     The current object type
         *     @var int    $id       The current object ID
         *     @var string $field_id The ID of the field being updated
         *     @var bool   $repeat   Whether current field is repeatable
         *     @var bool   $single   Whether current field is a single database row
         * }
         *
