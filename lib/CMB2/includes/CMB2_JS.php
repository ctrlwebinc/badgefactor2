...
class CMB2_JS
{
    ...
    public static function enqueue()
    {
        ...
        if ($enqueue_wysiwyg) {
            wp_enqueue_script('cmb2-wysiwyg', CMB2_Utils::url('js/cmb2-wysiwyg.js'), ['jquery', 'wp-util'], CMB2_VERSION);
        }
    ...
    public static function register_colorpicker_alpha($enqueue = false)
    {
        ...
        $func('wp-color-picker-alpha', CMB2_Utils::url("js/wp-color-picker-alpha{$min}.js"), ['wp-color-picker'], '2.1.3');
    }
    ...
    {
        $func = $enqueue ? 'wp_enqueue_script' : 'wp_register_script';
        $func('jquery-ui-datetimepicker', CMB2_Utils::url('js/jquery-ui-timepicker-addon.min.js'), ['jquery-ui-slider'], '1.5.0');
    }
    ...
    {
        wp_register_script('iris', admin_url('js/iris.min.js'), ['jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch'], CMB2_VERSION);
