...
abstract class Test_CMB2_Types_Base extends Test_CMB2
{
    ...
    public function setUp()
    {
        ...
        $this->options_cb_test = [
            ...
            'fields' => [
                [
                    ...
                    'type'        => 'select',
                    'options_cb'  => [__CLASS__, 'options_cb'],
                ],
            ],
        ];

        $this->options_cb_and_array_test = [
        ...
        $this->term = $this->factory->term->create([
            'taxonomy' => 'category',
            'name'     => 'test_category',
        ]);
        $this->term2 = $this->factory->term->create([
            'taxonomy' => 'category',
            'name'     => 'number_2',
        ]);
        ...
        $this->attachment_id = $this->factory->attachment->create_object($this->img_name, $this->post_id, [
            'post_mime_type' => 'image/jpeg',
            'post_type'      => 'attachment',
        ]);
        $this->attachment_id2 = $this->factory->attachment->create_object('2nd-'.$this->img_name, $this->post_id, [
            'post_mime_type' => 'image/jpeg',
            'post_type'      => 'attachment',
        ]);
    }
