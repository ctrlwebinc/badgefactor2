...
class Test_CMB2_REST extends Test_CMB2_Rest_Base
{
    ...
    {
        $this->do_scenarios_test($this->get_read_scenarios(), ['CMB2_REST', 'is_readable']);
    }

    public function test_is_editable()
    {
        $this->do_scenarios_test($this->get_edit_scenarios(), ['CMB2_REST', 'is_editable']);
    }
    ...
    {
        $rest_box = new Test_CMB2_REST_Object(new CMB2([
            'id'           => $this->cmb_id,
    ...
    public function test_get_object_id()
    {
        ...
        $this->assertEquals(false, Test_CMB2_REST_Object::get_object_id([]));
    }
    ...
    public function test_update_rest_values()
    {
        ...
        $values = CMB2_REST::update_post_rest_values($new_values, (object) [
            'ID' => $this->post_id,
    ...
    {
        $values = CMB2_REST::get_post_rest_values([
            'id' => $this->post_id,
        ], 'cmb2', new WP_REST_Request(), 'post');
        $expected = [
