...
class Test_CMB2_Core extends Test_CMB2
{
    ...
    public function setUp()
    {
        ...
        $this->metabox_array = [
            ...
            'classes_cb' => [__CLASS__, 'custom_classes'],
            'id'         => $this->cmb_id,
            'fields'     => [
                'test_test' => [
                    'name'        => 'Name',
                    ...
                    'id'          => 'test_test',
                    'type'        => 'text',
                    'before_row'  => [__CLASS__, 'cmb_before_row'],
                    'before'      => 'testing before',
                    'after'       => [__CLASS__, 'cmb_after'],
        ...
        $this->defaults = [
            'id'                      => $this->cmb_id,
            'title'                   => '',
            'object_types'            => [], // Post type
            'context'                 => 'normal',
            'priority'                => 'high',
            'show_names'              => true, // Show field names on the left
            'show_on'                 => [], // Specific post IDs or page templates to display this metabox
    ...
    public function test_defaults_set()
    {
        ...
        $this->assertEquals($this->defaults, $cmb->meta_box, print_r([$this->defaults, $cmb->meta_box], true));
    }
    ...
    public function test_cmb2_print_metabox_form()
    {
        ...
        add_filter('cmb2_wrap_classes', [__CLASS__, 'custom_classes_filter'], 10, 2);
        $form_get = cmb2_get_metabox_form($this->cmb_id, $this->post_id);
        remove_filter('cmb2_wrap_classes', [__CLASS__, 'custom_classes_filter'], 10, 2);
    ...
    public function test_add_group_field($do_assertions = null)
    {
        ...
        $sub_field_id = $cmb->add_group_field($field_id, [
            'name' => 'Field 1',
            'id'   => 'first_field',
            'type' => 'text',
        ]);

        $this->assertEquals(['group_field', 'first_field'], $sub_field_id);
        ...
        $this->assertEquals(['group_field', 'colorpicker'], $sub_field_id);
    }
    ...
    public function test_group_field_param_callbacks()
    {
        ...
        $field_id = $cmb->update_field_property('group_field', 'options', [
            'closed' => true,
        ]);
        ...
        add_filter('cmb2_group_wrap_attributes', [__CLASS__, 'modify_group_attributes']);
        ...
        remove_filter('cmb2_group_wrap_attributes', [__CLASS__, 'modify_group_attributes']);

        // Test replacing default group render_row_cb.
        $cmb->update_field_property('group_field', 'render_row_cb', [__CLASS__, 'echo_field_id']);
        ...
        $cmb->update_field_property('group_field', 'render_row_cb', [__CLASS__, 'do_default_cmb_group_render_cb']);
    ...
    public function test_overloaded_cmb_method()
    {
        ...
        add_action('cmb2_inherit_fabulous', [__CLASS__, 'overloading_test'], 10, 2);
    ...
    public function test_group_wrap_attributes()
    {
        ...
        add_filter('cmb2_group_wrap_attributes', [$this, 'for_testing_cmb2_group_wrap_attributes'], 10, 2);
    ...
    {
        return ['callback-class', $cmb->cmb_id];
    }
