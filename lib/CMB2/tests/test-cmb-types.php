...
class Test_CMB2_Types extends Test_CMB2_Types_Base
{
    ...
    public function test_repeatable_field()
    {
        ...
        $this->field_test['fields'][0]['options'] = [
    ...
    public function test_is_valid_img_ext()
    {
        ...
        $valid_types = apply_filters('cmb2_valid_img_types', ['jpg', 'jpeg', 'png', 'gif', 'ico', 'icon']);
        ...
        add_filter('cmb2_valid_img_types', [__CLASS__, 'add_type_cb']);
    ...
    public function test_text_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object(), 'render'])
        );
    }
    ...
    public function test_hidden_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('hidden'), 'render'])
        );
    }
    ...
    public function test_text_medium_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('text_medium'), 'render'])
        );
    }
    ...
    public function test_text_email_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('text_email'), 'render'])
        );
    }
    ...
    public function test_text_url_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('text_url'), 'render'])
        );
    }
    ...
    public function test_text_date_field_after_value_update()
    {
        ...
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$type, 'render'])
        );
    ...
    public function test_text_money_field()
    {
        ...
        $this->assertHTMLstringsAreEqual(
            $expected_field,
            $this->capture_render([$this->get_field_type_object('text_money'), 'render'])
        );
        ...
        $type = $this->get_field_type_object([
            'type'         => 'text_money',
            'before_field' => '£',
        ]);
        ...
        $type = $this->get_field_type_object([
            'type'         => 'text_money',
            'before_field' => [__CLASS__, 'change_money_cb'],
        ]);
    ...
    public function test_textarea_small_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('textarea_small'), 'render'])
        );
    }
    ...
    public function test_textarea_code_field()
    {
        ...
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('textarea_code'), 'render'])
        );
    }
    ...
    public function test_text_date_timestamp_field_after_value_update()
    {
        ...
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object($field), 'render'])
        );
    ...
    public function test_text_datetime_timestamp_timezone_field_after_value_update()
    {
        if (version_compare(PHP_VERSION, '5.3') >= 0) {
            ...
            $this->assertHTMLstringsAreEqual(
                ...
                $this->capture_render([$this->get_field_type_object('text_datetime_timestamp_timezone'), 'render'])
            );
    ...
    public function test_select_timezone_field_after_value_update()
    {
        ...
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('select_timezone'), 'render'])
        );
    ...
    public function test_colorpicker_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('colorpicker'), 'render'])
        );
    }
    ...
    public function test_title_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('title'), 'render'])
        );
    }
    ...
    {
        update_post_meta($this->post_id, $this->options_test['fields'][0]['id'], ['false', 'one']);
    ...
    public function test_checkbox_field()
    {
        ...
        $this->check_box_assertion([$type_object, 'render']);

        update_post_meta($type_object->field->object_id, 'field_test_field', 'true');

        // Test when value exists
        $this->check_box_assertion([$this->get_field_type_object('checkbox'), 'render'], true);
        ...
        $this->check_box_assertion($type_object->checkbox([], false));
        ...
        $this->check_box_assertion($type_object->checkbox([], true), true);
    }
    ...
    {
        $set = wp_set_post_categories($this->post_id, [$this->term, 1]);
    ...
    public function test_file_list_field_after_value_update()
    {
        ...
        update_post_meta($this->post_id, $this->text_type_field['id'], [
        ...
        $this->assertHTMLstringsAreEqual(
            sprintf(
                '<input type="hidden" class="cmb2-upload-file cmb2-upload-list" name="field_test_field" id="field_test_field" value="" size="45" data-previewsize=\'[50,50]\' data-sizename=\''.$sizename.'\' data-queryargs=\'\' data-hash=\'4lavrjdps2t0\'/><input type="button" class="cmb2-upload-button button-secondary cmb2-upload-list" name="" id="" value="'.esc_attr__('Add or Upload Files', 'cmb2').'" data-hash=\'4lavrjdps2t0\'/><p class="cmb2-metabox-description">This is a description</p><ul id="field_test_field-status" class="cmb2-media-status cmb-attach-list">%1$s%2$s</ul>',
                $this->file_sprintf([
            ...
            $this->capture_render([$field_type, 'render'])
        );
    ...
    public function test_file_field_after_value_update()
    {
        ...
        $field_type = $this->get_field_type_object([
            'type'         => 'file',
            'preview_size' => [199, 199],
        ]);
    ...
    public function test_oembed_field()
    {
        $this->assertHTMLstringsAreEqual(
            ...
            $this->capture_render([$this->get_field_type_object('oembed'), 'render'])
        );
    }
    ...
    public function test_save_group()
    {
        ...
        foreach (['text', 'textarea_small', 'file'] as $type) {
        ...
        if ($is_53) {
            ...
            $expected['group'][0]['text_datetime_timestamp_timezone_utc'] = [1448056800, 1448060400];
    ...
    public function test_maybe_custom_field_object()
    {
        ...
        add_action('cmb2_render_test_custom', [__CLASS__, 'hey_macarena']);
        ...
        $this->assertSame('hey macarena!', $this->capture_render([$types, 'render']));

        add_filter('cmb2_render_class_test_custom', [__CLASS__, 'return_cmb2_type_title']);
        ...
        $this->assertHTMLstringsAreEqual($expected, $this->capture_render([$types, 'render']));
    }
    ...
    protected function get_test_hierarchical_terms()
    {
        ...
        for ($i = 0; $i < 3; $i++) {
            $terms[] = $term = $this->factory->term->create([
                'taxonomy' => 'category',
                'name'     => 'test_category'.$i,
            ]);
            for ($j = 0; $j < 2; $j++) {
                $terms[] = $subterm = $this->factory->term->create([
                    'taxonomy' => 'category',
                    'name'     => 'test_category'.$i.$j,
                    'parent'   => $term,
                ]);
                for ($y = 0; $y < 1; $y++) {
                    $terms[] = $this->factory->term->create([
                        'taxonomy' => 'category',
