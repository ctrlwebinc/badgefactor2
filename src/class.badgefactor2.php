...
class BadgeFactor2
{
    ...
    public function includes()
    {
        ...
        add_action('init', [Email::class, 'init_hooks']);
        add_action('init', [Issuer::class, 'init_hooks']);
        add_action('init', [Badge::class, 'init_hooks']);
        add_action('init', [Assertion::class, 'init_hooks']);

        if (is_admin() || (defined('WP_CLI') && WP_CLI)) {
            require_once BF2_ABSPATH.'src/admin/class.badgefactor2-admin.php';
            add_action('init', [BadgeFactor2_Admin::class, 'init_hooks']);
            add_action('init', [BadgrClient::class, 'init_hooks']);
        }
